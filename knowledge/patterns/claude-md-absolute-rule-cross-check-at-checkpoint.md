...
| §6 Photography | Image Generation Rule — Higgsfield (Flux 2 / Nano Banana / Soul depending on use case) prompts must be specific, distinct, grounded in §6. NEVER request readable text in prompts. NO stock photography. |

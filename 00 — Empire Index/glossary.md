...
- **AI Marketing Team / Content Engine** — Tier 3. Python-based autonomous marketing pipeline (FastAPI · APScheduler · anthropic SDK · Pydantic · supabase-py). Runs Sundays 18:00 EST. Powers social content, scored by per-client configurable pillars. **The first true scheduled-cron agent in the Optimus stack** and the prerequisite template every Tier-4 build inherits. $3,500 setup / $1,497 MRR. In development.
- **AI Autonomous Employee** — Tier 4. Custom-trained autonomous AI employee per client, running on an open-source agent harness (OpenClaw / Hermes / Letta / Pydantic AI / LangGraph — selection in `harness-research.md`). Per-client private GPU deployment. $7,500–15,000 setup / $2,500–5,000+ MRR. The productized destination of the four-tier upsell ladder. In development.
...
- **Self Learning Content Engine** — the Python service that powers the AI Marketing Team offering. Runs Sundays 18:00 EST via APScheduler inside a FastAPI service. Stack: FastAPI · anthropic SDK (Claude Sonnet weekly · Opus monthly deep-eval) · Pydantic · supabase-py. Per-client configurable pillars (database-driven). Build spec lives at `Offerings/02 AI Agents/03 Marketing Team/python-architecture.md`.
- **Four-tier upsell ladder** — Optimus's AI agent product progression: Tier 1 Chat Assistant ($1,500/$597) → Tier 2 Voice Receptionist ($2,500/$797) → Tier 3 Marketing Team ($3,500/$1,497) → Tier 4 Autonomous AI Employee ($7,500-15,000 / $2,500-5,000+). Total addressable MRR per fully-onboarded client: ~$5,400-7,900/mo. Marketing Team is also the prerequisite template every Tier-4 inherits. Source of truth: `anthony-rosa/north-star.md`.
- **Drink-Own-Champagne milestone** — Optimus's own marketing pipeline + inbound qualification + scheduling running autonomously by **2027-Q3** via Optimus's own Tier-4 Autonomous AI Employee instance. The strongest sales asset and one of the four moats per `anthony-rosa/north-star.md` § The Moat.
- **Four agent infrastructure primitives** — Memory store · Tool registry · Observability layer · Approval/sandboxing. Defined once in `Offerings/02 AI Agents/shared-knowledge/agent-infrastructure.md`; used by Marketing Team, Voice Receptionist, and Tier-4 Autonomous Employee. The compounding artifact across tiers — Tier-4 IS these primitives with an open-source harness on top.
